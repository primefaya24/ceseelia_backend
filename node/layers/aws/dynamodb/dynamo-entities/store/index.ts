  ...
  try {
    ...
    const command = new UpdateCommand({
      ...
      ExpressionAttributeValues: {
        ...
        ":storeCategoriyItemGroups": storeCategory.storeCategoriyItemGroups,
