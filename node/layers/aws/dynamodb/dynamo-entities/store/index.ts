  ...
  try {
    ...
    const command = new UpdateCommand({
      ...
      ExpressionAttributeValues: {
        ...
        ":storeCategoriyHashtags": storeCategory.storeCategoriyHashtags,
